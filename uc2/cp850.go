...
// cp850 maps CP850 high bytes (0x80-0xFF) to Unicode code points, and cp850Lower
// is the same mapping folded to lower case. Names in UC2 archives are stored in
// CP850; these tables drive the conversion to UTF-8 (libunuc2.c cp850*).
var cp850 = [128]uint16{
